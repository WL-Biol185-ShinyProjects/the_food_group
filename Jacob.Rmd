...
---
```{r}
National_obesity <- read.csv("National Obesity by State.csv")
National_obesity
```
        ...
        fluidRow(
          box(
            ...
            tags$ol(
              ...
              tags$li(strong("Chain Standardization:"), "Names standardized to consistent brands (e.g., 'McDonald's Restaurant' → 'McDonald's')"),
